...
<html>
    ...
    <head>
        ...
        <script src="scripts/validarUsuario.js" type="text/javascript"></script>
    </head>
    <body onload="limparForm()">
        ...
        <div class="conteudo">
            ...
            <form class="formulario" id="formulario" method="post" onsubmit="return validarUsuarioo();" action="acoesUsuario" >
                <%
